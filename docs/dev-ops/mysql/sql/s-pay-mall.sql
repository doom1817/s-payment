...
CREATE TABLE `pay_order` (
  ...
  `market_type` TINYINT NOT NULL DEFAULT 1 COMMENT '营销类型：0-无营销、1-拼团营销',
  `market_deduction_amount` decimal(8,2) unsigned DEFAULT NULL COMMENT '营销优惠金额',
  `pay_amount` decimal(8,2) unsigned DEFAULT NULL COMMENT '支付金额',
